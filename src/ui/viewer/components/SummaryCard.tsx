...
export function SummaryCard({ summary }: SummaryCardProps) {
  ...
  const sections = [
    { key: "investigated", label: "调查内容", content: summary.investigated, icon: "/icon-thick-investigated.svg" },
    { key: "learned", label: "学到的", content: summary.learned, icon: "/icon-thick-learned.svg" },
    { key: "completed", label: "已完成", content: summary.completed, icon: "/icon-thick-completed.svg" },
    { key: "next_steps", label: "下一步", content: summary.next_steps, icon: "/icon-thick-next-steps.svg" },
    ...
    <article className="card summary-card">
      <header className="summary-card-header">
        <div className="summary-badge-row">
          <span className="card-type summary-badge">会话总结</span>
